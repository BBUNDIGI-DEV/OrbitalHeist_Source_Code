...
public class Stage2MiddleBoss : MonoBehaviour
{
    ...
    private void onTimelineEnd(PlayableDirector pd)
    {
        ...
        UIManager.Instance.SFDialogueManager.PlayDialouge(eDialogueTag.Stage2_03_BlinEntrance, sfOnDialogueEnd.Invoke);
    }
}
